...
// compile =============
        ...
        var regexcode = /self\.\s*(move|turn|get|say|toggle|build|show|attack|push)\s*\(/g;
        var originCode2 = originCode.replace(regexcode, '$1(');
        var regexcode2 = /(move|turn|get|say|toggle|build|show|attack|push)\s*\(/g;
